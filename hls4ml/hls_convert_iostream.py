"""
hls4ml conversion for the DeepSets jet tagger using io_stream.

This starts from the same precision configuration as hls_convert_v2.py and
writes the generated project to models/hls4ml_deepsets_iostream/.
"""
import os
...
dense_result_prec = {
    "input_proj":          "ap_fixed<32,12>",
    "ds_block_0_fc1":      "ap_fixed<32,16>",
    # fc2 result: set for Dense compute layer; *_fc2_linear must also be set
    "ds_block_0_fc2":      "ap_fixed<32,16>",  # Keras [-159,121] -> I=8 (256>159)
    "ds_block_0_fc2_linear": "ap_fixed<32,16>",
    "ds_block_0_add":      "ap_fixed<32,16>",
    "ds_block_1_fc1":      "ap_fixed<32,16>",
    "ds_block_1_fc2":      "ap_fixed<32,16>",  # Keras [-37,23] -> I=6 (64>37)
    "ds_block_1_fc2_linear": "ap_fixed<32,16>",
    "ds_block_1_add":      "ap_fixed<32,16>",
    "ds_block_2_fc1":      "ap_fixed<32,16>",
    "ds_block_2_fc2":      "ap_fixed<32,16>",  # Keras [-99,114] -> I=7 (128>114)
    "ds_block_2_fc2_linear": "ap_fixed<32,16>",
    "ds_block_2_add":      "ap_fixed<32,16>",
    "head_fc1":            "ap_fixed<32,16>",
    "head_fc2":            "ap_fixed<32,16>",  # FP32 weights; bias ~= -64 needs I=7+
    "head_fc2_linear":     "ap_fixed<32,16>",  # model output; must hold [-40,-38]
    "global_average_pooling1d": "ap_fixed<32,16>",
}
...
# input_proj is the floating first projection; keep it high precision for the
# io_stream retune instead of inheriting the model default.
...
dense_accum_prec = {
    "ds_block_0_fc1": "ap_fixed<48,24>",  # 64 inputs * max~6 = 384; max=512
    "ds_block_0_fc2": "ap_fixed<48,24>",  # 128 inputs * max~15 = 1920; max=2048
    "ds_block_1_fc1": "ap_fixed<48,24>",
    "ds_block_1_fc2": "ap_fixed<48,24>",
    "ds_block_2_fc1": "ap_fixed<48,24>",
    "ds_block_2_fc2": "ap_fixed<48,24>",  # 128 inputs * max~11 = 1408; max=2048
    "head_fc1":       "ap_fixed<48,24>",
    "head_fc2":       "ap_fixed<48,24>",  # 64 inputs, FP32 weights
}
